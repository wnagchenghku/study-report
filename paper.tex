...
First, the consensus latency of \paxos protocols is notoriously high and 
unscalable~\cite{zookeeper,glendenning2011scalable}, incurring high 
...
Second, most existing \smr systems are not desgined to support unmodified 
server programs. To utilize existing \smr services such as 
ZooKeeper~\cite{zookeeper}, developers often have to rewrite their code to 
shoehorn their programs into the narrowly defined state machine interfaces 
